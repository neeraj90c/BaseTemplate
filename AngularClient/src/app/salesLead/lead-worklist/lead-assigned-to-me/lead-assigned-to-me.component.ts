...
@Component({
  selector: 'app-lead-assigned-to-me',
  templateUrl: './lead-assigned-to-me.component.html',
  styleUrls: ['./lead-assigned-to-me.component.scss']
})
export class LeadAssignedToMeComponent {
  ...
  getOpenLeads(data:GetWorkListDTO) {
    this._salesleadService.getLeadWorkList(data).subscribe(res => {
      this.LeadData = res.assignedToMe
