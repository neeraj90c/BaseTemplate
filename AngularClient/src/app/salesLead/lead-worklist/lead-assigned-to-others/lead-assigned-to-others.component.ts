...
@Component({
  selector: 'app-lead-assigned-to-others',
  templateUrl: './lead-assigned-to-others.component.html',
  styleUrls: ['./lead-assigned-to-others.component.scss']
})
export class LeadAssignedToOthersComponent {
  ...
  getOpenLeads(data:GetWorkListDTO) {
    this._salesleadService.getLeadWorkList(data).subscribe(res => {
      this.LeadData = res.assignedToOthers
