...
@Component({
  selector: 'app-success-leads',
  templateUrl: './success-leads.component.html',
  styleUrls: ['./success-leads.component.scss']
})
export class SuccessLeadsComponent implements OnInit {
  today: Date;
  startDate: Date;
